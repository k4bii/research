...
- `nb_repro_start.py` and `type_analysis.py` are the original local versions.
...
```powershell
.\.venv\Scripts\python.exe final_nb_repro_start.py intermediate-types-test.ipynb
```
...
repro = NBRepro("intermediate-types-test.ipynb")
